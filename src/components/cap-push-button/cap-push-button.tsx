...
export class PushButton {
  ...
  @Watch("on")
  onStateBeingChanged() {
    this.pushButtonStateChange.emit(this.on);
  }

  render() {
    if (this.on) {
      return <div innerHTML={this.icons["eye-outline"]}></div>;
    } else {
      return <div innerHTML={this.icons["eye-off-outline"]}></div>;
    }
  }
}
